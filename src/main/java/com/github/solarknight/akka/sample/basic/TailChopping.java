...
import com.github.solarknight.akka.sample.basic.TailChopping.Command;
import java.time.Duration;
import java.util.function.BiFunction;

/**
 * @see <a
 *     href=https://doc.akka.io/docs/akka/current/typed/interaction-patterns.html#latency-tail-chopping>Latency
 *     tail chopping</a>
 * @author peiheng.zph created on Jan 29, 2020
 * @version 1.0
 */
public class TailChopping<Reply> extends AbstractBehavior<Command> {
